...
#+begin_src python :tangle security/threat_model.py :mkdirp yes :comments link
"""
...
#+begin_src python :tangle security/toctou_vulnerabilities.py :mkdirp yes :comments link
"""
...
#+begin_src python :tangle security/link_attacks.py :mkdirp yes :comments link
"""
...
#+begin_src python :tangle security/permission_security.py :mkdirp yes :comments link
"""
...
#+begin_src python :tangle security/input_validation.py :mkdirp yes :comments link
"""
...
#+begin_src python :tangle security/secure_patterns.py :mkdirp yes :comments link
"""
...
#+begin_src python :tangle security/vulnerability_scanner.py :mkdirp yes :comments link :shebang #!/usr/bin/env python3
"""
